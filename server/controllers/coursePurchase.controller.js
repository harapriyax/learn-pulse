...
export const createRazorpayOrder = async (req, res) => {
  try {
    ...
    // Prevent paid checkout for free courses
    if (!course.coursePrice || course.coursePrice === 0) {
      return res.status(400).json({ message: "This course is free. Use the free enrollment endpoint." });
    }
...
// 1.5 Enroll in a free course (no payment required)
